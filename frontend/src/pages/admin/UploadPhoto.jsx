...
<p>Upload A Photo For Your Product</p>
...
{imagesPreview?.length > 0 &&
        imagesPreview.map((img, index) => (
          <div key={index}>
            ...
            <button onClick={() => handleImagePreviewDelete(img)}>Remove</button>
          </div>
        ))}
      ...
      {uploadedImages?.length > 0 &&
        uploadedImages.map((img, index) => (
          <div key={index}>
            ...
            <button onClick={() => deleteImage(img?.public_id)} disabled={isLoading || isDeleteLoading}>
              Delete
            </button>
          </div>
        ))}
...
<button onClick={submitHandler} disabled={isLoading || isDeleteLoading}>
